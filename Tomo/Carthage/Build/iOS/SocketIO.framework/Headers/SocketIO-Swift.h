...
- (void)send:(NSString * __nonnull)msg withData:(NSArray<NSData *> * __nonnull)datas;
...
- (void)once:(NSString * __nonnull)event callback:(void (^ __nonnull)(NSArray * __nonnull, SocketAckEmitter * __nonnull))callback;
